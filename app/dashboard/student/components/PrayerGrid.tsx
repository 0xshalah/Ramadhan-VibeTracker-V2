...
function PrayerCard({ time, isDone, name, onToggle }: PrayerCardProps) {
  return (
    <div
      onClick={onToggle}
...
interface PrayerGridProps {
  sholat: DailyProgress['sholat'];
  onToggle: (key: keyof DailyProgress['sholat']) => void;
  dynamicTimes: Record<string, string> | null;
}

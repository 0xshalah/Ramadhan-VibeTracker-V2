  ...
  return (
    <div className="flex h-screen bg-background-light dark:bg-background-dark font-display" style={{ fontFamily: 'Lexend, sans-serif' }}>
      ...
      <main className="flex-1 p-12 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-3xl font-black mb-4">Achievements & Badges</h1>
        <p className="text-sage-500 max-w-md">Unlock legendary badges by completing your Ramadan goals. Badge system is currently under development.</p>

    ...
    <div className="min-h-screen bg-background-light text-slate-900 flex flex-col scroll-smooth">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 mt-12 md:mt-0">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs font-bold uppercase tracking-wider mb-8">
          ...
          Quality Guaranteed by <a href="https://www.testsprite.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">TestSprite AI</a>
        </div>
        ...
        <div className="mt-2 mb-10 inline-flex items-center gap-3 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] bg-slate-50 px-5 py-2.5 rounded-full border border-slate-200 shadow-sm transition-all hover:border-primary/40 hover:text-slate-600 group">
          ...
          Next-Gen Security Powered by <a href="https://www.testsprite.com/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 font-black hover:underline transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded px-1">TestSprite AI Automation</a>
        </div>
        ...
        <section id="features" className="w-full max-w-5xl py-12 border-t border-slate-200">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:border-indigo-300 transition-colors">
              ...
              <p className="text-sm text-sage-600 leading-relaxed">Multi-tier access control hardened by <a href="https://www.testsprite.com/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 font-bold hover:underline">TestSprite's</a> dual gateway validation. Protects against role escalation while providing distinct user routing.</p>
            </div>
        ...
        <section id="about" className="w-full max-w-4xl py-12 border-t border-slate-200 text-center">
            ...
            <p className="text-sage-600 w-full sm:w-3/4 mx-auto leading-relaxed">
              Ramadhan VibeTracker V2 is engineered from scratch for Season 01. What started as a static mockup was transformed into a full-stack Next.js production app by <strong>Antigravity (Agentic AI)</strong> and validated by <a href="https://www.testsprite.com/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 font-black hover:underline">TestSprite's AI</a>. It features rigid Zod schemas and cost-optimized Firestore modeling.
            </p>
        </section>
